...
This course repository is updated to Angular v13, and there is a package-lock.json file available, for avoiding semantic
...
# Start cypress for end2end testing
